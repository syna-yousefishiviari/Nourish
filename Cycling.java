...
class Cycling {
    ...
    public Cycling (String n, int dur, int dis, int spee) {
        this.name = n;
        this.duration = dur;
        this.distance = dis;
        this.speed = spee;
   ...
   //returns string with all the variables
    ...
    public String toString() {
        String sent = "Name: " + name  + "Duration: " + duration +  "Distance: " + distance + "Speed: " + speed ;
        readerwriter();
        return sent;
    ...
    public void readerwriter() {
       ...
       previouswork.add("CYCLING ---->" + name + "--> Date:" + df.format(dateobj) + "Duration: " + duration +  "Distance: " + distance + "Speed: " + speed );
       System.out.println("CYCLING ---->" + name + "--> Date:" + df.format(dateobj) + "Duration: " + duration +  "Distance: " + distance + "Speed: " + speed );
